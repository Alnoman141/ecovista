...
import LocationSwitcher from "./LocationSwticher"

export default async function LocationComponent({ latitude, longitude }) {
  const { continent, countryName, city } = await getLocationData(
    latitude,
    longitude
  )
